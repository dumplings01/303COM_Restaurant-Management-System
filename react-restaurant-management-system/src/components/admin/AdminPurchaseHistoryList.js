...
function AdminPurchaseHistoryList() {
	...
	const columns = [
        ...
        { field: 'estimatedDeliveryTime', headerName: 'Estimated Delivery Time', maxWidth: 320, flex:1, editable: false },
		{ field: 'timeDelivered', headerName: 'Time Delivered', maxWidth: 320, flex:1, editable: false },
